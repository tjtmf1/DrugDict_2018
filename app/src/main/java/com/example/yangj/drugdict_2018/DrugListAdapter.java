...
public class DrugListAdapter extends ArrayAdapter<com.example.force.infodb.ProductInfo>{
    private List<ProductInfo> productInfoList;
    private Context context;
    public DrugListAdapter(@NonNull Context context, int resource, @NonNull List<ProductInfo> objects) {
